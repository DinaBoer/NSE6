...
if update_operation_analysis == 'yes':
    ...
    lhv_h2_kwh_kg = OA.lhv_h2_kwh_kg
...
# costs and revenues
onel_electricity_costs_ppa = [costs_E_PPA_2030, costs_E_PPA_2040, costs_E_PPA_2050]               # EUR/year
onel_electricity_costs_grid = [costs_E_market_2030, costs_E_market_2040, costs_E_market_2050]     # EUR/year
...
raw_factsheet_data = {
    ...
    'entry_tariff_h2_network': entry_tariff_h2_network,
    'capex_100mw': capex_100mw,
    'stack_replacement_100mw': stack_replacement_100mw,
    'opex_100mw': opex_100mw,
    'hwi_price': hwi_price,
    'onel_electricity_costs_ppa': onel_electricity_costs_ppa,
    'onel_electricity_costs_grid': onel_electricity_costs_grid,
...
# =============================================================================
# OPEX and stack replacement dfs
# =============================================================================
...
onel_annual_electricity_costs_ppa.loc['onel_annual_electricity_costs_ppa'] = np.array(df_yearly_data.loc['onel_electricity_costs_ppa']) / 1E6                         #in MEUR
onel_annual_electricity_costs_grid.loc['onel_annual_electricity_costs_grid'] = np.array(df_yearly_data.loc['onel_electricity_costs_grid']) / 1E6                      #in MEUR
...
onel_income_tax_rate_list = [0.258, 0.258, 0.258]             # in %
onel_inflation_list = [0.02, 0.02, 0.02]                      # in %
onel_loan_interest_rate_list = [0.065, 0.05, 0.035]           # in %
onel_length_of_loan_list = [15, 15, 15]                       # years
onel_loan_type = 'annuity'
onel_depreciation_list = el_lifetime_list                     # years  Possibly change to el_depreciation list = el_lifetime_list
onel_stacks_depreciation_list = [5, 5, 5]                     # years


# Cost data from 'cost data OWF' sheet
onel_contingency_list = [0.1, 0.1, 0.1]                               # in %
onel_loan_percentage_list = [0.50, 0.50, 0.50]                        # in %
onel_decommissioning_percentage_list = [0.02, 0.02, 0.02]             # in %
onel_electricity_grid_connection_tariff_list = [144.3, 144.3, 144.3]  # EUR/kW
...
onel_general_wacc = onel_general_wacc_list[active_index]
onel_lifetime = el_lifetime_list[active_index]
...
onel_income_tax_rate = onel_income_tax_rate_list[active_index]
onel_inflation = onel_inflation_list[active_index]
onel_loan_interest_rate = onel_loan_interest_rate_list[active_index]
onel_length_of_loan = onel_length_of_loan_list[active_index]
onel_depreciation = onel_depreciation_list[active_index]
onel_stack_depreciation = onel_stacks_depreciation_list[active_index]

onel_contingency = onel_contingency_list[active_index]
onel_loan_percentage = onel_loan_percentage_list[active_index]
onel_decommissioning_percentage = onel_decommissioning_percentage_list[active_index]
onel_electricity_grid_connection_tariff = onel_electricity_grid_connection_tariff_list[active_index]
...
onel_parameters = {
    ...
    "lifetime_investment": onel_lifetime,
    ...
    "wacc": onel_general_wacc,
    "income_tax_rate": onel_income_tax_rate,
    "inflation": onel_inflation,
    "loan_interest_rate": onel_loan_interest_rate,
    "loan_percentage": onel_loan_percentage,
    "decommissioning_percentage": onel_decommissioning_percentage,

    # Capital & Operational Expenditures (CAPEX / OPEX)
    "capex": onel_capex_100mw,
    "opex_df": df_onel_opex_100mw,
    "electricity_grid_connection": onel_electricity_grid_connection,
    "df_stack_replacement_costs": df_stack_replacement_100mw,
    "entry_tariff_h2_network": onel_entry_tariff_h2_network,
    "electricity_tax": onel_electricity_tax,

    # Technology Specific: Annual Cost and Revenue Dataframes
    "annual_electricity_costs_ppa": onel_annual_electricity_costs_ppa,
    "annual_electricity_costs_grid": onel_annual_electricity_costs_grid,
    "h2_storage_costs": onel_h2_storage_costs,
    "hydrogen_revenues": onel_h2_revenues,
    "hwi_revenues": onel_hwi_revenues,

    # Additional parameters required to generalize functions
    "depreciation": onel_depreciation,
    "annuity_loan": onel_annuity_loan_100mw,
    "construction_years_list": construction_years_list,
    "contingency_percentage": onel_contingency,
}